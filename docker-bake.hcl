...
target "platforms" {
  platforms = ALPINE_VERSION == "3.24" || ALPINE_VERSION == "3.23" || ALPINE_VERSION == "3.22" || ALPINE_VERSION == "3.21" || ALPINE_VERSION == "3.20" || ALPINE_VERSION == "latest" || ALPINE_VERSION == "edge" ? [
    "linux/amd64",
    "linux/arm/v6",
    "linux/arm/v7",
    "linux/arm64",
